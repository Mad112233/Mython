...
namespace ast {
    ...
    ReturnException::ReturnException(const runtime::ObjectHolder& object) :object_(object) {}
    ...
    FieldAssignment::FieldAssignment(VariableValue object, std::string field_name,
        std::unique_ptr<Statement> rv) :object_(move(object)), field_name_(move(field_name)), rv_(move(rv)) {}
